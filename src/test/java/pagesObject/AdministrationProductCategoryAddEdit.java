...
public class AdministrationProductCategoryAddEdit {
    ...
    public static By uploadProductPhoto = By.xpath("//h6[text()='Product Category Icon']/parent::div/following-sibling::div/descendant::input[@accept='image/jpeg,image/png,image/jpg']");
    ...
    public static By uploadPhotoSubProduct(int indexSubProduct) {
        return By.xpath("//p[text()='Sub Product Category']/parent::div/following-sibling::div/div[3]/div["+indexSubProduct+"]/descendant::input[@accept='image/jpeg,image/png,image/jpg']");
    }
